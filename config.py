...
MOTOR_SPEED_RPM = 30       # Target speed in RPM

# Motion smoothing
ACCEL_RAMP_ENABLED = True   # Apply linear acceleration/deceleration ramp
ACCEL_RAMP_STEPS = 80       # Ramp length in full motor steps (not microsteps)
ACCEL_START_FACTOR = 2.5    # Start/end delay multiplier vs cruise speed

# Control Modes
ENABLE_LIMIT_SWITCHES = True
AUTO_STOP_AT_LIMIT = False  # Stop motor when limit switch is pressed
